...
//         <Table className="min-w-[700px] md:min-w-full text-sm">
//           <TableHeader>
//             <TableRow className="bg-gray-100 dark:bg-gray-800">
//               <TableHead className="text-black dark:text-white min-w-[120px]">Name</TableHead>
//               <TableHead className="text-black dark:text-white min-w-[150px]">Email</TableHead>
//               <TableHead className="text-black dark:text-white min-w-[130px]">Phone Number</TableHead>
//               <TableHead className="text-black dark:text-white min-w-[100px]">Attendance</TableHead>
//               <TableHead className="text-black dark:text-white min-w-[80px]">Edit</TableHead>
//               <TableHead className="text-black dark:text-white min-w-[90px]">Delete</TableHead>
//             </TableRow>
//           </TableHeader>
...
//                 <TableCell className="text-xs break-all">{student.email}</TableCell>
...
//       <div className="hidden md:block lg:hidden overflow-x-auto w-full">
//         <Table className="min-w-full text-sm">
//           <TableHeader>
//             <TableRow className="bg-gray-100 dark:bg-gray-800">
//               <TableHead className="text-black dark:text-white">Name</TableHead>
//               <TableHead className="text-black dark:text-white">Contact</TableHead>
//               <TableHead className="text-black dark:text-white text-center">Actions</TableHead>
//             </TableRow>
//           </TableHeader>
